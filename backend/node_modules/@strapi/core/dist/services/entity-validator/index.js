...
const { yup, validateYupSchema } = strapiUtils__namespace;
const { isMediaAttribute, isScalarAttribute, getWritableAttributes } = strapiUtils__namespace.contentTypes;
const { isAnyToOne } = strapiUtils__namespace.relations;
const { ValidationError } = strapiUtils__namespace.errors;
