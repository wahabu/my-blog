...
const newEngine = (params)=>{
   ...
   */ const evaluate = async (params)=>{
        ...
        const resolveConditions = (ids)=>ids.map((id)=>providers.condition.get(id));
        const removeInvalidConditions = _.filter((condition)=>condition != null && _.isFunction(condition.handler));
