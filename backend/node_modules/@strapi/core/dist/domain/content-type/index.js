...
const warnDraftAndPublishReservedAttributes = (uid, schema)=>{
    if (schema.options?.draftAndPublish !== true) {
        return;
    }
    for (const attributeName of strapiUtils.contentTypes.findDraftAndPublishReservedAttributeNames(Object.keys(schema.attributes))){
        strapi.log.warn(strapiUtils.contentTypes.getDraftAndPublishReservedAttributeWarning(uid, attributeName));
    }
};
