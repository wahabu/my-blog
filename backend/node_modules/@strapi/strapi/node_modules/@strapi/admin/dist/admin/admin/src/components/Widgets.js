...
/* -------------------------------------------------------------------------------------------------
 * ProfileWidget
 * -----------------------------------------------------------------------------------------------*/ const DisplayNameTypography = styledComponents.styled(designSystem.Typography)`
  font-size: 2.4rem;
`;
const ProfileWidget = ()=>{
 ...
 * -----------------------------------------------------------------------------------------------*/ const Grid = styledComponents.styled(designSystem.Box)`
  ...
  overflow: hidden;
`;
const GridCell = styledComponents.styled(designSystem.Box)`
...
const LinkCell = styledComponents.styled(reactRouterDom.Link)`
