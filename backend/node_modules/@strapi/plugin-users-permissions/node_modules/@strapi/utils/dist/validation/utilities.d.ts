 ...
 * ```
 */
export declare const maybeRequired: (required?: boolean) => <T extends z.Schema>(schema: T) => z.ZodOptional<T> | z.ZodNonOptional<T>;
/**
 ...
 * ```
 */
export declare const maybeReadonly: (writable?: boolean) => <T extends z.Schema>(schema: T) => T | z.ZodReadonly<T>;
/**
 ...
 * ```
 */
export declare const maybeWithDefault: (defaultValue?: unknown) => <T extends z.Schema>(schema: T) => T | z.ZodDefault<T>;
/**
 ...
 * ```
 */
export declare const maybeWithMinMax: (min?: number, max?: number) => <R extends z.ZodString | z.ZodEmail | z.ZodNumber | z.ZodArray<z.ZodAny>>(schema: R) => z.ZodString | z.ZodNumber | z.ZodEmail | z.ZodArray<z.ZodAny>;
/**
 ...
 * ```
 */
export declare const augmentSchema: <T extends z.Schema>(schema: T, modifiers: ((schema: T) => z.Schema)[]) => T;
