...
const MANAGE_SEATS_URL = 'https://billing.strapi.io';
const useLicenseLimitNotification = ()=>{
    ...
    React__namespace.useEffect(()=>{
        ...
        const shouldDisplayNotification = !isNil__default.default(permittedSeats) && !window.sessionStorage.getItem(`${STORAGE_KEY_PREFIX}-${pathname}`) && licenseLimitStatus === 'OVER_LIMIT';
