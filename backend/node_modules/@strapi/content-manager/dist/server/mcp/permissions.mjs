 ...
 */ const buildLocaleSchema = (localeCodes, defaultLocale)=>{
    if (localeCodes !== null && localeCodes.length > 0) {
        let schema = z.enum(localeCodes).optional();
 ...
 */ const resolvePermittedLocaleSchema = (strapi, context, action, uid, localeCodes, defaultLocale, baseLocaleSchema)=>{
    ...
    let schema = z.enum(permitted).optional();
...
export { buildLocaleSchema, getComponentLeafPaths, getPermittedFields, getPermittedLocales, isContentTypeLocalized, resolvePermittedLocaleSchema };
