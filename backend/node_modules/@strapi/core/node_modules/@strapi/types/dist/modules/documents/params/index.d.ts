...
export type Pick<TSchemaUID extends UID.Schema, TKind extends Kind> = MatchAllIntersect<[
    ...
    [
        HasMember<TKind, 'hasPublishedVersion'>,
        PublicationStatus.Param
    ],
    [
        HasMember<TKind, 'publicationFilter'>,
        PublicationStatus.PublicationFilterParam
    ],
    [
...
export type Kind = 'sort' | 'sort:string' | 'sort:array' | 'sort:object' | 'fields' | 'fields:string' | 'fields:array' | 'filters' | 'populate' | 'populate:string' | 'populate:array' | 'populate:object' | 'pagination' | 'pagination:offset' | 'pagination:page' | 'status' | 'hasPublishedVersion' | 'publicationFilter' | 'locale' | 'locale:string' | 'locale:array' | 'plugin' | 'data' | 'data:partial' | '_q' | 'lookup';
