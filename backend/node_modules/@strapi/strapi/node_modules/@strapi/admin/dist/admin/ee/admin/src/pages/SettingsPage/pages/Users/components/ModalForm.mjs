const FORM_INITIAL_VALUES = window.strapi.features.isEnabled(window.strapi.features.SSO) ? {
    useSSORegistration: true
} : {};
const ROLE_LAYOUT = window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    [
        {
            label: {
