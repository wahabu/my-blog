...
import { Modal, CarouselInput, CarouselSlide, Box, CarouselActions, IconButton, Tabs, Flex, Typography, Button, Field, TextInput, Card, CardHeader, CardAsset, CardBody, CardContent, CardTitle, CardSubtitle, CardBadge } from '@strapi/design-system';
import { Plus, ArrowClockwise, PlusCircle } from '@strapi/icons';
import axios, { AxiosError } from 'axios';
import { useIntl } from 'react-intl';
import { styled } from 'styled-components';
import { ACCEPTED_FORMAT, DIMENSION, SIZE } from '../utils/constants.mjs';
