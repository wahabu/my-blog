...
const normalizeDeclaredMime = (mime)=>(mime ?? '').trim().split(';')[0].trim();
 ...
 */ const detectMimeFromBlob = async (blob)=>{
    try {
 ...
 */ const resolveFileMime = async (mime, blob)=>{
    const declared = normalizeDeclaredMime(mime);
...
exports.detectMimeFromBlob = detectMimeFromBlob;
exports.isGenericMime = isGenericMime;
exports.normalizeDeclaredMime = normalizeDeclaredMime;
exports.resolveFileMime = resolveFileMime;
//# sourceMappingURL=resolveFileMime.js.map
