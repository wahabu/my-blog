declare let admin: {
    ...
    services: {
        ...
        user: {
            ...
            createFirstAdmin: (attributes: Omit<Partial<import("../../shared/contracts/shared").AdminUserCreationPayload>, "registrationToken" | "isActive" | "roles">) => Promise<import("../../shared/contracts/shared").AdminUser>;
            updateById: (id: import("@strapi/types/dist/data/constants.js").ID, attributes: Partial<import("../../shared/contracts/shared").AdminUserUpdatePayload>) => Promise<import("../../shared/contracts/shared").AdminUser>;
            exists: (attributes?: unknown) => Promise<boolean>;
            findRegistrationInfo: (registrationToken: string) => Promise<Pick<import("../../shared/contracts/shared").AdminUser, "email" | "firstname" | "lastname"> | undefined>;
            ...
            findOne: (id: import("@strapi/types/dist/data/constants.js").ID, populate?: string[]) => Promise<any>;
            findOneByEmail: (email: string, populate?: never[]) => Promise<any>;
            findPage: (params?: {}) => Promise<unknown>;
            deleteById: (id: import("@strapi/types/dist/data/constants.js").ID) => Promise<import("../../shared/contracts/shared").AdminUser | null>;
            ...
            assignARoleToAll: (roleId: import("@strapi/types/dist/data/constants.js").ID) => Promise<void>;
            ...
            isFirstSuperAdminUser: (userId: import("@strapi/types/dist/data/constants.js").ID) => Promise<boolean>;
        };
        role: {
            hooks: {
            ...
            deleteByIds: (ids?: import("@strapi/types/dist/data/constants.js").ID[]) => Promise<import("../../shared/contracts/shared").AdminRole[]>;
            getUsersCount: (roleId: import("@strapi/types/dist/data/constants.js").ID) => Promise<number>;
            ...
            addPermissions: (roleId: import("@strapi/types/dist/data/constants.js").ID, permissions: any) => Promise<import("../../shared/contracts/shared").Permission[]>;
            hasSuperAdminRole: (user: import("../../shared/contracts/shared").AdminUser) => boolean;
            assignPermissions: (roleId: import("@strapi/types/dist/data/constants.js").ID, permissions?: Array<Pick<import("../../shared/contracts/shared").Permission, "action" | "subject" | "conditions">>) => Promise<import("../../shared/contracts/shared").Permission[]>;
            resetSuperAdminPermissions: () => Promise<void>;
            checkRolesIdForDeletion: (ids?: import("@strapi/types/dist/data/constants.js").ID[]) => Promise<void>;
            constants: {
        ...
        metrics: {
            ...
            sendUpdateProjectInformation: (strapi: import("@strapi/types/dist/core/strapi.js").Strapi) => Promise<void>;
            startCron: (strapi: import("@strapi/types/dist/core/strapi.js").Strapi) => void;
        };
        ...
        homepage: ({ strapi }: {
            ...
            getHomepageLayout: (userId: number) => Promise<import("./controllers/validation/schema").HomepageLayout | null>;
            updateHomepageLayout: (userId: number, input: unknown) => Promise<import("./controllers/validation/schema").HomepageLayout>;
        };
    };
    controllers: {
        admin: {
            ...
            getGuidedTourMeta(ctx: import("koa").Context): Promise<{
                data: {
                    ...
                    schemas: import("@strapi/types/dist/public/registries.js").ContentTypeSchemas;
                };
            }>;
        };
        'api-token': {
        ...
        'admin-token': {
            ...
            regenerate(ctx: import("koa").Context): Promise<any>;
            list(ctx: import("koa").Context): Promise<void>;
            revoke(ctx: import("koa").Context): Promise<any>;
            get(ctx: import("koa").Context): Promise<void>;
            update(ctx: import("koa").Context): Promise<any>;
            getOwnerPermissions(ctx: import("koa").Context): Promise<any>;
        };
        'authenticated-user': {
            getMe(ctx: import("koa").Context): Promise<void>;
            updateMe(ctx: import("koa").Context): Promise<any>;
            getOwnPermissions(ctx: import("koa").Context): Promise<void>;
        };
        'authenticated-session': {
            list(ctx: import("koa").Context): Promise<any>;
            revoke(ctx: import("koa").Context): Promise<any>;
            revokeAll(ctx: import("koa").Context): Promise<any>;
        };
        authentication: {
            ...
            register(ctx: import("koa").Context): Promise<any>;
            registerAdmin(ctx: import("koa").Context): Promise<any>;
            forgotPassword(ctx: import("koa").Context): Promise<void>;
            resetPassword(ctx: import("koa").Context): Promise<any>;
            accessToken(ctx: import("koa").Context): Promise<any>;
        ...
        role: {
            ...
            update(ctx: import("koa").Context): Promise<any>;
            getPermissions(ctx: import("koa").Context): Promise<any>;
            updatePermissions(ctx: import("koa").Context): Promise<any>;
        ...
        webhooks: {
            ...
            getWebhook(ctx: import("koa").Context): Promise<any>;
            createWebhook(ctx: import("koa").Context): Promise<void>;
            updateWebhook(ctx: import("koa").Context): Promise<any>;
            deleteWebhook(ctx: import("koa").Context): Promise<any>;
            deleteWebhooks(ctx: import("koa").Context): Promise<any>;
        ...
        homepage: {
            getKeyStatistics(): Promise<{
                data: Awaited<ReturnType<() => Promise<{
                    assets: number;
                    contentTypes: number;
                    components: number;
                    locales: any;
            ...
            getHomepageLayout(ctx: import("koa").Context): Promise<{
                data: import("./controllers/validation/schema").HomepageLayout | null;
            }>;
            updateHomepageLayout(ctx: import("koa").Context): Promise<{
                data: import("./controllers/validation/schema").HomepageLayout;
            }>;
        };
        ai: {
            getAiToken(ctx: import("koa").Context): Promise<any>;
            getAiUsage(ctx: import("koa").Context): Promise<any>;
            getAiFeatureConfig(ctx: import("koa").Context): Promise<any>;
        };
    };
    contentTypes: {
        permission: {
