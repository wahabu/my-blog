...
declare const controllersRegistry: (strapi: Core.Strapi) => {
     ...
     */
    set(uid: UID.Controller, value: ControllerFactory): /*elided*/ any;
    /**
     * Registers a map of controllers for a specific namespace
     */
    add(namespace: string, newControllers: ControllerFactoryMap): /*elided*/ any;
    /**
     * Wraps a controller to extend it
     */
    extend(controllerUID: UID.Controller, extendFn: ControllerExtendFn): /*elided*/ any;
};
