...
import { getApiErrorMessage } from '../utils/getApiErrorMessage.mjs';
 ...
 */ const useApiErrorMessage = ()=>{
    ...
    return React.useCallback((error, fallback)=>{
        const message = getApiErrorMessage(error);
        if (!message) {
            return fallback;
        }
        const id = getTranslationKey(`apiError.${message}`);
        return messages[id] ? formatMessage({
            id
        }) : message;
    }, [
        formatMessage,
...
export { useApiErrorMessage };
//# sourceMappingURL=useApiErrorMessage.mjs.map
