...
const uploadFiles = async (files = {})=>{
    ...
    return Promise.all(Object.values(files).filter((file)=>file?.stream instanceof fs__default.default.ReadStream).map((file)=>strapi.plugin('upload').provider.uploadStream(file)));
};
