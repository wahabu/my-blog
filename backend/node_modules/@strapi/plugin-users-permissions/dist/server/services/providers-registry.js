...
var verifyJwtWithJwks = require('../utils/verify-jwt-with-jwks.js');
var providerHttp = require('../utils/provider-http.js');
var oauth1 = require('../utils/oauth-connect/oauth1.js');
...
function requireProvidersRegistry() {
    ...
    const { verifyJwtWithJwks: verifyJwtWithJwks$1 } = verifyJwtWithJwks.__require();
    const { bearerGet, fetchJson } = providerHttp.__require();
    const initProviders = ({ baseURL })=>({
            ...
            twitter: {
                ...
                async authCallback ({ accessToken, query, providers }) {
                    const { twitterGet } = oauth1.__require();
            ...
            cognito: {
                ...
                async authCallback ({ query, providers }) {
                    ...
                    const tokenPayload = await verifyJwtWithJwks$1({
                        idToken,
                        jwksUrl
                    });
                    return {
