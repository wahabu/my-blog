...
import { Pencil, ExternalLink, Duplicate } from '@strapi/icons';
import { stringify } from 'qs';
import { useIntl } from 'react-intl';
import { useNavigate, useHref, NavLink } from 'react-router-dom';
...
const OpenInNewTabAction = ({ documentId })=>{
    const { formatMessage } = useIntl();
    const { canRead } = useDocumentRBAC('OpenInNewTabAction', ({ canRead })=>({
            canRead
        }));
    const [{ query }] = useQueryParams();
    ...
    return {
        ...
        icon: /*#__PURE__*/ jsx(StyledExternalLink, {}),
        label: formatMessage({
