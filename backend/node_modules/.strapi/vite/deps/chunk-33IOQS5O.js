...
var en = {
  ...
  "Settings.permissions.auditLogs.audit-log.export": "Export audit logs",
  ...
  "Settings.permissions.auditLogs.listview.export": "Export as CSV",
  "Settings.permissions.auditLogs.listview.export.error": "The export failed. Please try again.",
  "Settings.permissions.auditLogs.listview.export.error.forbidden": "You don't have the permissions to export audit logs.",
  "Settings.permissions.auditLogs.listview.export.error.tooLarge": "Table too large to export. Please add filters and try again.",
  "Settings.permissions.auditLogs.listview.export.leave": "Are you sure you want to leave? Your ongoing export will be canceled.",
  "Settings.permissions.auditLogs.listview.export.progress.caption": "Preparing your export - {fetched, number} out of {total, plural, one {# event} other {# events}}",
  "Settings.permissions.auditLogs.listview.export.progress.title": "Exporting audit logs",
  "Settings.permissions.auditLogs.listview.export.ready.download": "Download CSV",
  "Settings.permissions.auditLogs.listview.export.ready.title": "Export ready",
  ...
  "Settings.permissions.auditLogs.release.create": "Create release",
  "Settings.permissions.auditLogs.release.update": "Update release",
  "Settings.permissions.auditLogs.release.delete": "Delete release",
  "Settings.permissions.auditLogs.release.trigger": "Trigger release",
  "Settings.permissions.auditLogs.release.entry.add": "Add entry to release",
  "Settings.permissions.auditLogs.release.entry.update": "Change entry on release",
  "Settings.permissions.auditLogs.release.entry.remove": "Remove entry from release",
  "Settings.permissions.auditLogs.release.settings.update": "Update release settings",
...
//# sourceMappingURL=chunk-33IOQS5O.js.map
