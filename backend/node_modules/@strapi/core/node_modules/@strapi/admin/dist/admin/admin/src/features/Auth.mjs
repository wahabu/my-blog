...
import { logout, setToken, setLocale, login, getStoredToken } from '../reducer.mjs';
...
import { attemptTokenRefresh, setOnSessionExpired, setOnTokenUpdate } from '../utils/getFetchClient.mjs';
...
const AuthProvider = ({ children, _defaultPermissions = [], _disableRenewToken = false })=>{
   ...
   */ const clearLocalSessionAndRedirect = React.useCallback(()=>{
    ...
    const resyncToken = React.useCallback((newToken)=>{
