...
import { __require as requireOauth1 } from './oauth1.mjs';
import { __require as requireOauth2 } from './oauth2.mjs';
import { __require as requireUtils } from '../index.mjs';
...
function requireOauthConnect() {
    ...
    const builtinProviderEndpoints = requireProviders();
    const oauth1 = requireOauth1();
    const oauth2 = requireOauth2();
...
export { requireOauthConnect as __require };
