...
import {
  SearchInput
} from "./chunk-3WXPYN7U.js";
import {
  ConfirmDialog
} from "./chunk-AA275WBF.js";
import {
  Filters,
  Pagination
} from "./chunk-Y5R3VJ7W.js";
import {
  Table
} from "./chunk-JPNDKHBX.js";
import {
  errorsTrads
...
} from "./chunk-DCSZDLCR.js";
import {
  Form
} from "./chunk-2POPB6BT.js";
import {
  useRBAC
...
var ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(ROLE_LAYOUT, async () => (await import("./ModalForm-ST7C4SV4.js")).ROLE_LAYOUT, {
  ...
  const initialValues = useEnterprise(FORM_INITIAL_VALUES, async () => (await import("./ModalForm-ST7C4SV4.js")).FORM_INITIAL_VALUES, {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-LC7XUX25.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-U343MJN6.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-SXYIGXMS.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-LMIZX2ZX.js.map
