...
const IndicatorContainer = styledComponents.styled(designSystem.Box)`
  position: absolute;
  z-index: 1;
  pointer-events: none;
...
`;
const DotContainer = styledComponents.styled(designSystem.Box)`
  position: absolute;
  top: 50%;
  left: ${({ $position })=>$position}%;
  transform: translate(-50%, -50%);
`;
const Dot = styledComponents.styled(designSystem.Box)`
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
const ResizeHandleContainer = styledComponents.styled(designSystem.Box)`
  position: absolute;
  top: 0;
  bottom: 0;
...
`;
const ResizeHandleBar = styledComponents.styled(designSystem.Box)`
  width: 2px;
  height: 100%;
