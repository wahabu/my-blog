...
var LazyOutlet = require('../components/LazyOutlet.js');
...
const { version: strapiVersion } = packageInfo__default.default;
const AdminLayout = ()=>{
    ...
    const { isLoading: isLoadingMenu, generalSectionLinks, pluginsSectionLinks, topMobileNavigation, burgerMobileNavigation } = useMenu.useMenu(checkLatestStrapiVersion(strapiVersion, tagName), appInfo?.currentEnvironment);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ jsxRuntime.jsx(LazyOutlet.LazyOutlet, {
                                                suspenseOnly: true
                                            })
                                        ]
                                    })
