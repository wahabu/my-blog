...
async function loginAction(ctx, { showDashboardLink = true } = {}) {
        ...
        if (isTokenValid) {
            try {
                ...
                if (showDashboardLink) {
                    ...
                    logger.log(chalk__default.default.underline(`${api.apiConfig.dashboardBaseUrl}/projects`));
                }
                return true;
            } catch (e) {
    ...
    const deviceAuthResponse = await axios__default.default.post(cliConfig.deviceCodeAuthUrl, {
        client_id: cliConfig.clientId,
        scope: cliConfig.scope,
        audience: cliConfig.audience
    }).catch((e)=>{
    ...
    const authenticate = async ()=>{
        ...
        while(!isAuthenticated){
            try {
                const tokenResponse = await axios__default.default.post(cliConfig.tokenUrl, tokenPayload);
