 ...
 */ const RelationsField = /*#__PURE__*/ React.forwardRef(({ disabled, label, ...props }, ref)=>{
     ...
     */ const relations = React.useMemo(()=>{
       ...
       */ const connectItems = (field.value?.connect ?? []).map((rel)=>{
            ...
            return {
                ...rel,
                label: hasEmptyMainField ? getRelationLabel(rel, props.mainField, emptyLabel) : rel.label ?? getRelationLabel(rel, props.mainField, emptyLabel),
...
const ListItem = /*#__PURE__*/ React.memo(({ data, index, style })=>{
   ...
   */ const collectionType = getCollectionType(href);
    ...
    const label = isTemporary && document ? getRelationLabel(document, mainField, emptyLabel) : originalLabel;
