...
var ptBR = {
  ...
  "containers.list.items": "{number} {number, plural, =0 {itens} one {item} other {itens}}",
  ...
  "error.validation.max": "O valor é muito alto (máx: {max}).",
  "error.validation.maxLength": "O valor é muito longo (máx: {max}).",
  "error.validation.min": "O valor é muito baixo (mín: {min}).",
  "error.validation.minLength": "O valor é muito curto (mín: {min}).",
...
//# sourceMappingURL=pt-BR.json-SM5UUBWK.js.map
