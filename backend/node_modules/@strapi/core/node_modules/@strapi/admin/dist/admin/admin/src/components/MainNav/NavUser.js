...
`;
const MenuIcon = styledComponents.styled(designSystem.Flex)`
...
const MenuContent = styledComponents.styled(designSystem.Menu.Content)`
  ...
  width: 200px;
`;
const UserInfo = styledComponents.styled(designSystem.Flex)`
  && {
    padding: ${({ theme })=>theme.spaces[3]};
  }
  align-items: flex-start;
`;
const BadgeWrapper = styledComponents.styled(designSystem.Flex)`
  display: flex;
  flex-wrap: wrap;
  ...
  width: 100%;
`;
const StyledTypography = styledComponents.styled(designSystem.Typography)`
