...
export declare const createServiceUtils: ({ strapi }: {
    ...
    getRelationRestoreValue: (versionRelationData: Modules.Documents.AnyDocument | Modules.Documents.AnyDocument[], attribute: Schema.Attribute.RelationWithTarget) => Promise<Modules.Documents.AnyDocument | Modules.Documents.AnyDocument[] | null>;
