 ...
 */ const componentToSchema = (strapi, attribute)=>{
    ...
    const componentSchema = utils.safeSchemaCreation(strapi, component$1, ()=>new component.CoreComponentRouteValidator(strapi, component$1).entry);
 ...
 */ const mediaToSchema = (strapi, attribute)=>{
    ...
    const mediaSchema = utils.safeSchemaCreation(strapi, fileSchema.uid, ()=>new contentType.CoreContentTypeRouteValidator(strapi, fileSchema.uid).document);
 ...
 */ const relationToSchema = (strapi, attribute)=>{
    ...
    const targetSchema = utils.safeSchemaCreation(strapi, target, ()=>new contentType.CoreContentTypeRouteValidator(strapi, target).document);
