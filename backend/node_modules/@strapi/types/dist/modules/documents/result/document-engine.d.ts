...
export type FindOne<TContentTypeUID extends UID.ContentType, TParams extends Params.FindOne<TContentTypeUID>> = Promise<Result<TContentTypeUID, TParams> | null>;
