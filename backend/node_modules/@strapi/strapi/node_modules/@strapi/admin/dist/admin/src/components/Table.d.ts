...
declare const useTable: <Selected, ShouldThrow extends boolean = true>(consumerName: string, selector: (value: DefaultTableContextValue) => Selected, shouldThrowOnMissingContext?: ShouldThrow | undefined) => ShouldThrow extends true ? Selected : Selected | undefined;
