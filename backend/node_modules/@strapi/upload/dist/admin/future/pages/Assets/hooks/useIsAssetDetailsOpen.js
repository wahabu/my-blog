...
/** Name of the parameter to look for in the URL to open the asset details drawer. */ const ASSET_DETAILS_URL_PARAM = 'assetId';
/**
 ...
 */ const useIsAssetDetailsOpen = ()=>{
    const [{ query }] = strapiAdmin.useQueryParams();
    return parseAssetDetailsId(query?.[ASSET_DETAILS_URL_PARAM]) !== null;
};

exports.ASSET_DETAILS_URL_PARAM = ASSET_DETAILS_URL_PARAM;
exports.parseAssetDetailsId = parseAssetDetailsId;
exports.useIsAssetDetailsOpen = useIsAssetDetailsOpen;
//# sourceMappingURL=useIsAssetDetailsOpen.js.map
