...
/* -------------------------------------------------------------------------------------------------
 * Styled
 * -----------------------------------------------------------------------------------------------*/ const StyledProgressBar = styledComponents.styled(designSystem.ProgressBar)`
  width: 100%;
...
`;
const Container = styledComponents.styled(designSystem.Flex)`
  width: 100%;
  ...
  align-items: stretch;
`;
const ContentSection = styledComponents.styled(designSystem.Flex)`
  flex: 1;
  padding: ${({ theme })=>theme.spaces[8]};
`;
const VerticalSeparator = styledComponents.styled.div`
  width: 1px;
  background-color: ${({ theme })=>theme.colors.neutral150};
`;
const TourTaskContainer = styledComponents.styled(designSystem.Flex)`
  &:not(:last-child) {
    border-bottom: ${({ theme })=>`1px solid ${theme.colors.neutral150}`};
  }
  padding: ${({ theme })=>theme.spaces[4]};
`;
const TodoCircle = styledComponents.styled(designSystem.Box)`
