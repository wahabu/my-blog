...
type SingleSelectPropsWithoutLabel = Omit<SelectParts.SingleSelectProps, 'value'> & Pick<SelectParts.ContentProps, 'onCloseAutoFocus'> & Pick<SelectParts.TriggerProps, 'clearLabel' | 'onClear' | 'startIcon' | 'name' | 'id' | 'hasError' | 'size' | 'loading'> & Pick<SelectParts.ValueProps, 'placeholder'> & {
    /**
...
export declare const SingleSelect: React.ForwardRefExoticComponent<Omit<import('@strapi/ui-primitives/dist/components/Select/Select').SingleSelectProps, "value"> & Pick<import('@strapi/ui-primitives/dist/components/Select/Select').SelectContentImplProps, "onCloseAutoFocus"> & Pick<SelectParts.TriggerProps, "id" | "name" | "loading" | "size" | "startIcon" | "hasError" | "clearLabel" | "onClear"> & Pick<SelectParts.ValueProps, "placeholder"> & {
    /**
     * @default (value) => value.toString()
     */
    customizeContent?(value?: string | number): string;
