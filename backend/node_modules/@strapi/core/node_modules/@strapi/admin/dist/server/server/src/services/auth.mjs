...
import { expiresInToSeconds } from './token.mjs';
import '@strapi/types';
 ...
 */ const getResetPasswordTokenTTL = ()=>{
    ...
    const seconds = expiresInToSeconds(configured) ?? expiresInToSeconds(DEFAULT_RESET_PASSWORD_TOKEN_EXPIRES_IN);
    return seconds * 1000;
};
/**
...
export { assertResetPasswordTokenIsValid, assignResetPasswordToken, auth as default, getResetPasswordTokenTTL };
