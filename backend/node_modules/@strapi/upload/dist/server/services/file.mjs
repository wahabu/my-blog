...
import { errors, file as file$1, async } from '@strapi/utils';
import { FILE_MODEL_UID, FOLDER_MODEL_UID } from '../constants.mjs';
import { getService } from '../utils/index.mjs';

const { ApplicationError } = errors;
const { bytesToHumanReadable } = file$1;
 ...
 */ const fetchUrlToInputFile = async (url, tmpWorkingDirectory, sizeLimit, onProgress)=>{
    ...
    try {
        if (response.body === null) {
            ...
            await pipeline(Readable.fromWeb(response.body), counter, createWriteStream(tmpFilePath));
        }
    } catch (error) {
