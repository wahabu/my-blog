 ...
 */ const isQsArrayLimitPopulateObject = (value)=>{
    if (!fp.isObject(value) || fp.isArray(value)) {
        return false;
    }
...
const throwQsArrayLimitPopulateError = (entryCount)=>{
    throw new errors.ValidationError(`Too many populate entries (${entryCount}). The maximum number of populate entries when using array notation is ${DEFAULT_QS_ARRAY_LIMIT}. ` + 'Consider using object notation (populate[field]=true), nested population, or reducing the number of fields.');
};
