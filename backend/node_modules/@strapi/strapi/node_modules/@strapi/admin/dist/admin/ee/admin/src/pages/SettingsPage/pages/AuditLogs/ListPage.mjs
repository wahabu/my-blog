...
import { useQueryParams, withEncodedUserParams } from '../../../../../../../admin/src/hooks/useQueryParams.mjs';
...
const ListPage = ()=>{
    ...
    const openLog = (id)=>setQuery(withEncodedUserParams(query, {
            id
        }), 'push', true);
    const closeLog = ()=>setQuery(withEncodedUserParams(query, {
            id: undefined
        }), 'push', true);
