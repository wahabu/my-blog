...
export declare const hasOrderColumn: (attribute: RelationalAttribute) => attribute is Relation.OneToMany | Relation.ManyToMany;
export declare const hasInverseOrderColumn: (attribute: RelationalAttribute) => attribute is Relation.ManyToOne | Relation.ManyToMany;
/**
