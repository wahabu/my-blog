...
declare const servicesRegistry: (strapi: Core.Strapi) => {
     ...
     * Registers a service
     */
    set(uid: string, service: ServiceFactory): /*elided*/ any;
    /**
     * Registers a map of services for a specific namespace
     */
    add(namespace: string, newServices: ServiceFactoryMap): /*elided*/ any;
    /**
     * Wraps a service to extend it
     */
    extend(uid: UID.Service, extendFn: ServiceExtendFn): /*elided*/ any;
};
