 ...
 */ const isManyRelationForMcp = (attribute)=>MANY_RELATION_TYPES.has(attribute.relation ?? '');
/**
 ...
 */ const reduceToIdentity = (attribute, value)=>{
    const isMany = isManyRelationForMcp(attribute);
    if (isMany) {
        if (Array.isArray(value)) {
            return value.map(pickIdentity).filter((v)=>v !== undefined);
        }
 ...
 */ const shapeRelationToIdentity = ({ key, value, attribute }, { set })=>{
    ...
    set(key, reduceToIdentity(attribute, value));
};
/**
 ...
 */ const shapeRelationsForMcp = async (uid, data)=>{
    return strapiUtils.traverseEntity(shapeRelationToIdentity, {
...
exports.MANY_RELATION_TYPES = MANY_RELATION_TYPES;
exports.isManyRelationForMcp = isManyRelationForMcp;
exports.reduceToIdentity = reduceToIdentity;
exports.shapeRelationsForMcp = shapeRelationsForMcp;
//# sourceMappingURL=shape-relations.js.map
