...
/* eslint-disable react/no-array-index-key */ const TabForm = ({ form, formErrors, genericInputProps, modifiedData, onChange })=>{
    ...
    const sharedInputProps = genericInputProps;
    return /*#__PURE__*/ jsxRuntime.jsx(jsxRuntime.Fragment, {
        children: form.map((section, sectionIndex)=>{
            ...
            return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Box, {
                 ...
                 */ const value = get__default.default(modifiedData, input.name, undefined);
                            ...
                            const errorId = pluginOptionError ? formErrors[pluginOptionError]?.id : get__default.default(formErrors, [
                            ...
                            if (input.type === 'condition-form') {
                                const currentCondition = get__default.default(modifiedData, input.name);
                                // Get all attributes from the content type schema
                                const contentTypeAttributes = sharedInputProps.contentTypeSchema?.attributes ?? [];
                                ...
                                return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                                    ...
                                    direction: "column",
                                    alignItems: "stretch",
                                    children: currentCondition === null || currentCondition === undefined || Object.keys(currentCondition).length === 0 ? /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
