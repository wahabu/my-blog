...
const sortContentType = (types)=>{
    return sortBy__default.default(Object.keys(types).map((uid)=>({
        ...
        })).filter((obj)=>obj !== null), (obj)=>camelCase__default.default(obj.title));
};
    ...
    return {
        ...
        attributes: type.attributes.map((attr)=>{
            ...
            return {
                action,
                name: attr.name,
                properties: removeNullKeys(omit__default.default(formatAttribute(attr), [
                    'status',
                    'name'
                ]))
            };
