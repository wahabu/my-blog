...
const DataManagerProvider = ({ children })=>{
    ...
    const isModified = React__namespace.useMemo(()=>{
        return !(isEqual__default.default(components, initialComponents) && isEqual__default.default(contentTypes, initialContentTypes));
    }, [
        components,
        contentTypes,
        initialComponents,
    ...
    getDataRef.current = async ()=>{
        try {
            ...
            dispatch(reducer.actions.init({
                components: mapValues__default.default(components, (component)=>({
                        ...component,
                        status: 'UNCHANGED'
                    })),
                contentTypes: mapValues__default.default(contentTypes, (contentType)=>({
                        ...contentType,
                        status: 'UNCHANGED'
                    })),
    ...
    const componentsGroupedByCategory = React__namespace.useMemo(()=>{
        return groupBy__default.default(components, 'category');
    }, [
        components
    ]);
    ...
    const context = {
        ...
        addAttribute (payload) {
            dispatch(reducer.actions.addAttribute({
                ...payload,
                attributeToSet: payload.attributeToSet
            }));
        },
        editAttribute (payload) {
            dispatch(reducer.actions.editAttribute({
                ...payload,
                attributeToSet: payload.attributeToSet
            }));
        },
