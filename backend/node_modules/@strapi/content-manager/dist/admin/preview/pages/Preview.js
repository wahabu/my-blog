...
const getPreviewScript = (()=>{
    let previewScript = '';
    return async (previewHighlightColors)=>{
        if (!previewScript) {
        ...
        return `(${previewScript})(${JSON.stringify({
            ...
            events: constants.INTERNAL_EVENTS,
                ...
                try {
                    ...
                    toggleNotification({
                        ...
                        message: formatMessage({
                            ...
                            defaultMessage: 'Could not load the live preview script. Visual editing may not be available.'
                        })
                    });
                }
            }
