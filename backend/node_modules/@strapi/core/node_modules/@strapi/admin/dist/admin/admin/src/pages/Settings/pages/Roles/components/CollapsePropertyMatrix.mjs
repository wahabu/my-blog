...
import { getLocaleValidationErrorActionKeys } from '../utils/localePermissionValidation.mjs';
...
const CollapsePropertyMatrix = ({ availableActions = [], childrenForm = [], isFormDisabled, label, pathToData, propertyName, subject })=>{
    ...
    const localeValidationErrorLabels = React.useMemo(()=>{
        ...
        return propertyActions.filter(({ actionId, isActionRelatedToCurrentProperty })=>isActionRelatedToCurrentProperty && errorKeys.includes(actionId)).map(({ label })=>label);
    }, [
        propertyName,
        subject,
        modifiedData,
    ...
    return /*#__PURE__*/ jsxs(Flex, {
        ...
        children: [
            ...
            localeValidationErrorLabels.length > 0 && /*#__PURE__*/ jsx(Box, {
                paddingLeft: 6,
                paddingTop: 2,
                paddingBottom: 2,
