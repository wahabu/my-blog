...
declare const Layouts: {
    Root: ({ sideNav, children, ...restProps }: LayoutProps) => import("react/jsx-runtime").JSX.Element;
    Header: {
    ...
    Action: ({ startActions, endActions, bottomActions }: import("./ActionLayout").ActionLayoutProps) => import("react/jsx-runtime").JSX.Element | null;
