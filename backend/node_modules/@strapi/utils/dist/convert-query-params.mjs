...
const setSortMapValue = (field, order)=>{
    const path = ___default.toPath(field);
    const sortMap = {};
    let current = sortMap;
...
const createTransformer = ({ getModel })=>{
   ...
   */ const convertSortQueryParams = (sortQuery)=>{
    ...
    const convertSingleSortQueryParam = (sortQuery)=>{
        ...
        return setSortMapValue(field, order.trim());
    };
    const convertNestedSortQueryParam = (sortQuery)=>{
        ...
        for (const field of Object.keys(sortQuery)){
            ...
            if (isPlainObject(order)) {
                ...
                throw new ValidationError(`Invalid sort type expected object or string got ${typeof order}`);
            }
        }
   ...
   */ const convertLimitQueryParams = (limitQuery)=>{
    ...
    const convertPopulateObject = (populate, schema)=>{
         ...
         */ if ('populate' in subPopulate && !isNil(subPopulate.populate) && subPopulate.populate !== '*') {
