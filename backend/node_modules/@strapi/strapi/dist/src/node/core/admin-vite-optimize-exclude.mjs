 ...
 */ const ADMIN_VITE_OPTIMIZE_DEPS_EXCLUDE_ALLOWLIST = new Set([
 ...
 *
 * @internal exported for tests
 */ const packageOptsIntoOptimizeDepsExclude = (pkg)=>{
    const strapi = pkg.strapi;
 ...
 *
 * @internal exported for tests
 */ const isEligibleForOptimizeDepsExclude = (name, pkg)=>{
...
export { ADMIN_VITE_OPTIMIZE_DEPS_EXCLUDE_ALLOWLIST, collectAdminOptimizeDepsExclude, getPluginPackageName, hasReactPeerDependency, isEligibleForOptimizeDepsExclude, isEsmPackage, packageOptsIntoOptimizeDepsExclude, shipsPreBuiltDist, shouldExcludeFromOptimizeDeps };
