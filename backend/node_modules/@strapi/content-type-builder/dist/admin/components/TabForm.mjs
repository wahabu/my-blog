...
import { getAvailableConditionFields } from '../utils/conditions.mjs';
                 ...
                 */ const value = get(modifiedData, input.name, undefined);
                            ...
                            if (input.type === 'condition-form') {
                                ...
                                return /*#__PURE__*/ jsx(Grid.Item, {
                                    ...
                                    direction: "column",
                                    alignItems: "stretch",
                                    children: currentCondition === null || currentCondition === undefined || Object.keys(currentCondition).length === 0 ? /*#__PURE__*/ jsx(Box, {
