...
var schemaRegistry = require('./core-api/routes/validation/schema-registry.js');
...
class Strapi extends container.Container {
   ...
   */ get entityService() {
    ...
    registerInternalServices() {
        ...
        this.add('config', ()=>config$1).add('query-params', queryParams(this)).add('content-api', index$1(this)).add('content-api-schema-registry', ()=>schemaRegistry.createContentAPISchemaRegistry()).add('auth', index$2()).add('server', ()=>index$3.createServer(this)).add('fs', ()=>fs(this)).add('eventHub', ()=>eventHub()).add('startupLogger', ()=>startupLogger.createStartupLogger(this)).add('logger', ()=>logger$1).add('fetch', ()=>fetch.createStrapiFetch(this)).add('features', ()=>features.createFeaturesService(this)).add('requestContext', requestContext).add('customFields', customFields(this)).add('entityValidator', index$4).add('entityService', ()=>index$5({
                strapi: this,
                db: this.db
