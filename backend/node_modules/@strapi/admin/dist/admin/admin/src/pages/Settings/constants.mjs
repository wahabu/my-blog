const ADMIN_TOKEN_ROUTES = [
    {
        lazy: async ()=>{
            const { ProtectedListView } = await import('./pages/AdminTokens/ListView.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await import('./pages/AdminTokens/CreateView.mjs');
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await import('./pages/AdminTokens/EditView/EditViewPage.mjs');
            return {
