...
const hasI18nLayoutOptions = (options)=>'i18n' in options && typeof options.i18n === 'object' && options.i18n !== null;
...
const isFieldLocalized = (attribute, layout)=>{
    const contentTypeLocalized = hasI18nLayoutOptions(layout.options) && layout.options.i18n?.localized === true;
