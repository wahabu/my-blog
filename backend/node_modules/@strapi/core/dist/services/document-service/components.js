    ...
    for (const attributeName of attributeNames){
        ...
        if (attribute.type === 'component' || attribute.type === 'dynamiczone') {
            ...
            if (attribute.type === 'component') {
                ...
                await strapiUtils.async.map(___default.default.castArray(value), (subValue)=>deleteComponent(componentUID, subValue));
            } else {
                await strapiUtils.async.map(___default.default.castArray(value), (subValue)=>deleteComponent(subValue.__component, subValue));
            }
            continue;
        }
    }
 ...
 */ const shouldPropagateComponentRelationToNewVersion = async (componentRelation, componentSchema, parentSchemasForComponent, trx)=>{
    ...
    const componentIdColumn = strapi.db.metadata.identifiers.getJoinColumnAttributeIdName(___default.default.snakeCase(componentSchema.modelName));
