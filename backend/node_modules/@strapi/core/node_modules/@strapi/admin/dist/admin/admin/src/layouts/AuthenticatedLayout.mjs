...
import { LazyOutlet } from '../components/LazyOutlet.mjs';
...
const AdminLayout = ()=>{
    ...
    const { isLoading: isLoadingMenu, generalSectionLinks, pluginsSectionLinks, topMobileNavigation, burgerMobileNavigation } = useMenu(checkLatestStrapiVersion(strapiVersion, tagName), appInfo?.currentEnvironment);
