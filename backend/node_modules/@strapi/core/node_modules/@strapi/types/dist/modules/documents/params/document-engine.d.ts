 ...
 */
export type FindMany<TContentTypeUID extends UID.ContentType> = Pick<TContentTypeUID, 'fields' | 'filters' | '_q' | 'pagination' | 'sort' | 'populate' | 'status' | 'publicationFilter' | 'hasPublishedVersion' | 'locale' | 'plugin' | 'lookup'>;
export type Count<TContentTypeUID extends UID.ContentType> = FindMany<TContentTypeUID>;
export type FindFirst<TContentTypeUID extends UID.ContentType> = Pick<TContentTypeUID, 'fields' | 'filters' | '_q' | 'sort' | 'populate' | 'status' | 'publicationFilter' | 'hasPublishedVersion' | 'locale:string' | 'plugin' | 'lookup'>;
...
export type Delete<TContentTypeUID extends UID.ContentType> = Pick<TContentTypeUID, 'fields' | 'populate' | 'filters' | 'status' | 'publicationFilter' | 'hasPublishedVersion' | 'locale:string' | 'lookup'> & {
    documentId: ID;
};
