...
const RelationNaturePicker = ({ naturePickerType, oneThatIsCreatingARelationWithAnother, relationType, target, targetUid })=>{
    ...
    const dataType = naturePickerType === 'component' ? 'component' : get__default.default(contentTypes, [
        targetUid,
        'kind'
    ], '');
    ...
    const targetLabel = get__default.default(contentTypes, [
        target,
        'info',
        'displayName'
    ], 'unknown');
    ...
    const restrictedRelations = get__default.default(contentTypes, [
        target,
        'restrictRelationsTo'
    ], null);
    const rightDisplayedValue = pluralize__default.default(rightTarget, [
        'manyToMany',
        'oneToMany',
        'manyToOne',
        'manyWay'
            ...
            /*#__PURE__*/ jsxRuntime.jsxs(Components.InfosWrapper, {
                ...
                children: [
                    /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Typography, {
                        children: [
                            truncate__default.default(leftDisplayedValue, {
                                length: 24
                            }),
                            " "
                        ]
                    ...
                    /*#__PURE__*/ jsxRuntime.jsx(designSystem.Typography, {
                        children: truncate__default.default(rightDisplayedValue, {
                            length: 24
                        })
                    })
                ]
