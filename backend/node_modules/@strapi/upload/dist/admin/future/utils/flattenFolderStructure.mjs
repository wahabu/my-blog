 ...
 */ const flattenFolderStructure = (nodes, excludeSubtreeIds = new Set(), parentLabel = '')=>nodes.flatMap((node)=>{
...
export { flattenFolderStructure };
//# sourceMappingURL=flattenFolderStructure.mjs.map
