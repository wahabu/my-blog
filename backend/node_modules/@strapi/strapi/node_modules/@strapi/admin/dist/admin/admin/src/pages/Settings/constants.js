...
const ADMIN_TOKEN_ROUTES = [
    {
        lazy: async ()=>{
            const { ProtectedListView } = await Promise.resolve().then(function () { return require('./pages/AdminTokens/ListView.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedCreateView } = await Promise.resolve().then(function () { return require('./pages/AdminTokens/CreateView.js'); });
            return {
    ...
    {
        lazy: async ()=>{
            const { ProtectedEditView } = await Promise.resolve().then(function () { return require('./pages/AdminTokens/EditView/EditViewPage.js'); });
            return {
