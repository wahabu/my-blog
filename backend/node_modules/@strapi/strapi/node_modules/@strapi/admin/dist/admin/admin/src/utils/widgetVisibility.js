 ...
 */ const CLOUD_DEPLOY_MENU_LINK = 'plugins/cloud';
const isProductionEnvironment = (currentEnvironment)=>currentEnvironment === 'production';
/**
 ...
 */ const hideCloudDeployMenuLinkInProduction = (menuLinks, currentEnvironment)=>{
    if (!isProductionEnvironment(currentEnvironment)) {
        return menuLinks;
    }
...
exports.CLOUD_DEPLOY_MENU_LINK = CLOUD_DEPLOY_MENU_LINK;
exports.DEPLOY_NOW_WIDGET_UID = DEPLOY_NOW_WIDGET_UID;
exports.hideCloudDeployMenuLinkInProduction = hideCloudDeployMenuLinkInProduction;
