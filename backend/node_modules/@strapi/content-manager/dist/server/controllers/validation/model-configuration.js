...
const createSettingsSchema = (schema)=>{
    ...
    return strapiUtils.yup.object().shape({
        ...
        // should be reset when the type changes
        defaultSortBy: strapiUtils.yup.string()// eslint-disable-next-line no-template-curly-in-string -- Yup interpolation placeholder
        .test('is-valid-sort-attribute', '${path} is not a valid sort attribute', async (value)=>settings.isValidDefaultSort(schema, value)).default('id'),
