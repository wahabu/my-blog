...
} from "./chunk-3WKN3JAY.js";
import {
  useConfiguration
} from "./chunk-TKZBDVP5.js";
import {
  useEnterprise
} from "./chunk-HRURINY4.js";
import {
  useRBAC
} from "./chunk-SHEU3VT4.js";
import {
  Layouts
...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-DUOXIMUI.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-3CIGRWBJ.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-6DCJ4C5Z.js.map
