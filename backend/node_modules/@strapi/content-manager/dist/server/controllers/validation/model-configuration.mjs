...
const createSettingsSchema = (schema)=>{
    ...
    return yup.object().shape({
        ...
        // should be reset when the type changes
        defaultSortBy: yup.string()// eslint-disable-next-line no-template-curly-in-string -- Yup interpolation placeholder
        .test('is-valid-sort-attribute', '${path} is not a valid sort attribute', async (value)=>isValidDefaultSort(schema, value)).default('id'),
