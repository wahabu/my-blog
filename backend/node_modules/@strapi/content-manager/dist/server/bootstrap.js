...
var registerContentManagerMcpTools = require('./mcp/register-content-manager-mcp-tools.js');
...
var bootstrap = (async ()=>{
    ...
    await registerContentManagerMcpTools.registerContentManagerMcpTools({
        strapi
    });
