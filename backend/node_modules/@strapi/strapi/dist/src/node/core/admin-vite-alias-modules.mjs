 ...
 *
 * @internal
 */ const ADMIN_VITE_DEDUPE_ONLY_MODULES = [
    '@strapi/strapi'
];
/**
...
export { ADMIN_VITE_ALIAS_MODULES, ADMIN_VITE_DEDUPE_MODULES, ADMIN_VITE_DEDUPE_ONLY_MODULES, ADMIN_VITE_SINGLETON_MODULES };
