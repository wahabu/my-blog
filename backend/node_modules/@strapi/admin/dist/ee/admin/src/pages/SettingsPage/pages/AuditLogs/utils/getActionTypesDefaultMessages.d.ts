export declare const actionTypes: {
    ...
    'release.update': string;
    'release.delete': string;
    'release.trigger': string;
    'release.entry.add': string;
    'release.entry.update': string;
    'release.entry.remove': string;
    'release.settings.update': string;
    'audit-log.export': string;
};
