...
var _diagnostics = /*#__PURE__*/ _class_private_field_loose_key("_diagnostics"), _checksumsEnabled = /*#__PURE__*/ _class_private_field_loose_key("_checksumsEnabled"), /**
   ...
   */ _assetEncoding = /*#__PURE__*/ _class_private_field_loose_key("_assetEncoding"), _startStepOnce = /*#__PURE__*/ _class_private_field_loose_key("_startStepOnce"), _startStep = /*#__PURE__*/ _class_private_field_loose_key("_startStep"), _endStep = /*#__PURE__*/ _class_private_field_loose_key("_endStep"), _streamStep = /*#__PURE__*/ _class_private_field_loose_key("_streamStep"), _writeStream = /*#__PURE__*/ _class_private_field_loose_key("_writeStream"), _reportInfo = /*#__PURE__*/ _class_private_field_loose_key("_reportInfo"), _reportWarning = /*#__PURE__*/ _class_private_field_loose_key("_reportWarning");
class RemoteStrapiDestinationProvider {
    ...
    async initTransfer() {
        ...
        if (res.assetEncoding === 'base64') {
            _class_private_field_loose_base(this, _assetEncoding)[_assetEncoding] = 'base64';
        } else {
            _class_private_field_loose_base(this, _assetEncoding)[_assetEncoding] = 'legacy-buffer-json';
            _class_private_field_loose_base(this, _reportWarning)[_reportWarning]('[Data transfer][push] Remote does not support the compact base64 asset-chunk format; ' + 'falling back to legacy Buffer JSON. Large files may cause out-of-memory errors on the remote — ' + 'upgrade the remote Strapi to pick up PR #23479 to use the memory-bounded wire format.');
        }
        this.resetStats();
    ...
    createAssetsWriteStream() {
        ...
        const encodeAssetChunk = _class_private_field_loose_base(this, _assetEncoding)[_assetEncoding] === 'base64' ? transferAssetChunk.createTransferAssetStreamChunk : transferAssetChunk.createTransferAssetStreamChunkLegacy;
    ...
    constructor(options){
        ...
        Object.defineProperty(this, _assetEncoding, {
            writable: true,
            value: void 0
        });
