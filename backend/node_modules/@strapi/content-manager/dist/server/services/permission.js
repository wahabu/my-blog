...
var permission = (({ strapi })=>({
        ...
        async registerPermissions () {
            const allContentTypes = index.getService('content-types').findAllContentTypes();
            const allContentTypesUids = allContentTypes.map(fp.prop('uid'));
            const contentTypesUids = allContentTypes.filter(({ isDisplayed })=>isDisplayed).map(fp.prop('uid'));
            const actions = [
                {
