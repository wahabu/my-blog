...
declare const _default: (body: unknown, errorMessage?: string) => Promise<import("yup/lib/object").AssertsShape<import("yup/lib/object").Assign<import("yup/lib/object").ObjectShape, {
