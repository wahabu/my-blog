 ...
 */
export type McpToolResult<OutputSchema extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = {
 ...
 */
export type McpToolHandlerReturn<OutputSchema extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = McpToolResult<OutputSchema>;
 ...
 */
export type McpToolDefinitionFields<Name extends string = string, InputSchema extends z.ZodObject<z.ZodRawShape> | undefined = z.ZodObject<z.ZodRawShape> | undefined, OutputSchema extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>, Title extends string = string, Description extends string = string> = {
    name: Name;
    title: Title;
...
export interface McpToolBuilder {
    <Name extends string, OutputSchema extends z.ZodObject<z.ZodRawShape>, Title extends string, Description extends string, InputSchema extends z.ZodObject<z.ZodRawShape> | undefined = undefined>(tool: McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpDevModeAccess): McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpDevModeAccess;
    <Name extends string, OutputSchema extends z.ZodObject<z.ZodRawShape>, Title extends string, Description extends string, InputSchema extends z.ZodObject<z.ZodRawShape> | undefined = undefined>(tool: McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpAuthAccess): McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpAuthAccess;
}
/**
 * Callback function for Strapi MCP prompts
 */
export type McpPromptCallback<ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined> = ArgsSchema extends z.ZodTypeAny ? (args: z.infer<ArgsSchema>, extra: McpCapabilityHandlerContext) => Promise<McpPromptResult> : (extra: McpCapabilityHandlerContext) => Promise<McpPromptResult>;
/**
 ...
 */
export type McpPromptDefinitionFields<Name extends string = string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined = z.ZodObject<z.ZodRawShape> | undefined, Title extends string = string, Description extends string = string> = {
    name: Name;
    title: Title;
    description: Description;
 ...
 */
export type McpPromptDefinition<Name extends string = string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined = z.ZodObject<z.ZodRawShape> | undefined, Title extends string = string, Description extends string = string> = McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpCapabilityAccess;
/**
...
export interface McpPromptBuilder {
    <Name extends string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined, Title extends string, Description extends string>(prompt: McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpDevModeAccess): McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpDevModeAccess;
    <Name extends string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined, Title extends string, Description extends string>(prompt: McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpAuthAccess): McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpAuthAccess;
}
/**
 * Callback function for Strapi MCP resources
 */
export type McpResourceCallback = (uri: URL, extra: McpCapabilityHandlerContext) => Promise<McpResourceReadResult>;
/**
 ...
 */
export type McpResourceDefinition<Name extends string = string> = McpResourceDefinitionFields<Name> & McpCapabilityAccess;
/**
...
export interface McpResourceBuilder {
    <Name extends string>(resource: McpResourceDefinitionFields<Name> & McpDevModeAccess): McpResourceDefinitionFields<Name> & McpDevModeAccess;
    <Name extends string>(resource: McpResourceDefinitionFields<Name> & McpAuthAccess): McpResourceDefinitionFields<Name> & McpAuthAccess;
}
...
export interface McpService {
     ...
     */
    registerTool<Name extends string, OutputSchema extends z.ZodObject<z.ZodRawShape>, Title extends string, Description extends string, InputSchema extends z.ZodObject<z.ZodRawShape> | undefined = undefined>(tool: McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpDevModeAccess): void;
    registerTool<Name extends string, OutputSchema extends z.ZodObject<z.ZodRawShape>, Title extends string, Description extends string, InputSchema extends z.ZodObject<z.ZodRawShape> | undefined = undefined>(tool: McpToolDefinitionFields<Name, InputSchema, OutputSchema, Title, Description> & McpAuthAccess): void;
    /**
     ...
     * @throws Error if called after the MCP server has started
     */
    registerPrompt<Name extends string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined, Title extends string, Description extends string>(prompt: McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpDevModeAccess): void;
    registerPrompt<Name extends string, ArgsSchema extends z.ZodObject<z.ZodRawShape> | undefined, Title extends string, Description extends string>(prompt: McpPromptDefinitionFields<Name, ArgsSchema, Title, Description> & McpAuthAccess): void;
    /**
     ...
     * @throws Error if called after the MCP server has started
     */
    registerResource<Name extends string>(resource: McpResourceDefinitionFields<Name> & McpDevModeAccess): void;
    registerResource<Name extends string>(resource: McpResourceDefinitionFields<Name> & McpAuthAccess): void;
    /**
