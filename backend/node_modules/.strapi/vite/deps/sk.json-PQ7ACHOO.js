...
var sk = {
  ...
  "media.multiple": "Viacero",
  "component.repeatable": "(opakujúce)",
  "components.SelectComponents.displayed-value": "{number, plural, =0 {# komponentov} one {# komponent} other {# komponenty}} vybrané",
  ...
  "contentType.apiId-singular.description": "UID sa používa na generovanie API routov a databázových tabuliek/kolekcií",
  ...
  "error.contentType.pluralName-used": "Táto hodnota nemôže byť rovnaká ako jednotná",
  "error.contentType.singularName-used": "Táto hodnota nemôže byť rovnaká ako množná",
  "error.contentType.singularName-equals-pluralName": "Táto hodnota nemôže byť rovnaká ako množné API ID iného typu obsahu.",
  "error.contentType.pluralName-equals-singularName": "Táto hodnota nemôže byť rovnaká ako jednotné API ID iného typu obsahu.",
  "error.contentType.pluralName-equals-collectionName": "Táto hodnota sa už používa iným typom obsahu.",
  ...
  "error.validation.enum-empty-string": "Prázdne reťazce nie sú povolené",
  "error.validation.enum-regex": "Aspoň jedna hodnota je neplatná. Hodnoty by mali obsahovať aspoň jeden abecedný znak pred prvým výskytom čísla.",
  "error.validation.minSupMax": "Nemôže byť nadradený",
  "error.validation.positive": "Musí byť kladné číslo",
  ...
  "form.attribute.item.date.type.date": "dátum (napr.: 01/01/{currentYear})",
  "form.attribute.item.date.type.datetime": "dátum a čas (napr.: 01/01/{currentYear} 00:00 AM)",
  "form.attribute.item.date.type.time": "čas (napr.: 00:00 AM)",
  ...
  "form.attribute.item.maximumComponents": "Maximum komponentov",
  "form.attribute.item.maximumLength": "Maximálna dĺžka",
  "form.attribute.item.minimum": "Minimálna hodnota",
  "form.attribute.item.minimumComponents": "Minimum komponentov",
  ...
  "form.attribute.item.uniqueField.v5.willBeDisabled'": "Momentálne unikátne polia v komponentoch nefungujú správne. Ak túto funkciu vypnete, pole bude vypnuté, kým sa to neopraví.",
  "form.attribute.item.uniqueField.v5.disabled": "Momentálne unikátne polia v komponentoch nefungujú správne. Toto pole bolo vypnuté, kým sa to neopraví.",
  ...
  "form.attribute.condition.title": "Podmienka",
  "form.attribute.condition.description": "Prepínať nastavenia poľa podľa hodnoty iného boolean alebo enum poľa.",
  "form.attribute.condition.label": "Podmienky",
  ...
  "form.attribute.condition.operator.isNot": "nie je",
  "form.attribute.condition.value.true": "true",
  "form.attribute.condition.value.false": "false",
  "form.attribute.condition.apply": "Použiť podmienku",
  "form.attribute.condition.then": "Potom",
  "form.attribute.condition.action": "Akcia",
  "form.attribute.condition.action.show": "Zobraziť",
  "form.attribute.condition.action.hide": "Skryť",
  "form.attribute.condition.no-fields": "Nie sú dostupné žiadne boolean ani enum polia, na ktoré by bolo možné nastaviť podmienky.",
  "form.attribute.condition.enum-change-warning": "Nasledujúce polia majú podmienky, ktoré závisia od tohto poľa: {fieldNames}. Zmena alebo odstránenie enum hodnôt {values} tieto podmienky poruší. Chcete pokračovať?",
  "form.attribute.condition.enum-change-warning-values": ". Zmena alebo odstránenie enum hodnôt ",
  "form.attribute.condition.enum-change-warning-end": " poruší tieto podmienky. Chcete pokračovať?",
  "form.attribute.condition.field-change-warning": "Nasledujúce polia majú podmienky, ktoré závisia od tohto poľa: {fieldNames}. Jeho premenovanie tieto podmienky poruší. Chcete pokračovať?",
  "form.attribute.condition.field-change-warning-end": ". Jeho premenovanie poruší tieto podmienky. Chcete pokračovať?",
  ...
  "modalForm.collectionType.header-create": "Vytvoriť collection type",
  ...
  "modalForm.empty.button": "Pridať vlastné polia",
  "modalForm.empty.heading": "Zatiaľ tu nič nie je.",
  "modalForm.empty.sub-heading": "Nájdite, čo hľadáte, prostredníctvom širokej škály rozšírení.",
  ...
  "modalForm.custom-fields.advanced.settings.extended": "Rozšírené nastavenia",
  "modalForm.tabs.custom": "Vlastné",
  "modalForm.tabs.custom.howToLink": "Ako pridať vlastné polia",
  "modalForm.tabs.default": "Predvolené",
  "modalForm.tabs.label": "Karty Predvolené a Vlastné typy",
  ...
  "notification.error.dynamiczone-min.validation": "Aspoň jeden komponent je povinný v dynamickej zóne, aby bolo možné uložiť typ obsahu",
  ...
  "popUpWarning.discardAll.message": "Naozaj chcete zahodiť všetky zmeny?",
  "popUpWarning.bodyMessage.delete-condition": "Naozaj chcete odstrániť túto podmienku?",
  "popUpWarning.bodyMessage.delete-attribute-with-conditions": "Nasledujúce polia majú podmienky, ktoré závisia od tohto poľa: ",
  "popUpWarning.bodyMessage.delete-attribute-with-conditions-end": ". Naozaj ho chcete odstrániť?",
  ...
  "table.button.no-fields": "Pridať nové pole",
  "table.content.create-first-content-type.title": "Žiadne typy obsahu",
  "table.content.create-first-content-type.description": "Vytvorte collection types, single types a komponenty, aby ste mohli zostaviť svoju schému.",
  "table.content.create-first-content-type.import-code": "Importovať z počítača",
  "table.content.create-first-content-type.start-with-prompt": "Začať s výzvou",
  "table.content.no-fields.collection-type": "Pridajte svoje prvé pole do tohto Collection-Type",
  "table.content.no-fields.component": "Pridajte svoje prvé pole do tohto komponentu",
  "IconPicker.search.placeholder.label": "Vyhľadať ikonu",
  "IconPicker.search.clear.label": "Vymazať vyhľadávanie ikon",
  "IconPicker.search.button.label": "Tlačidlo na vyhľadanie ikony",
  "IconPicker.remove.tooltip": "Odstrániť vybranú ikonu",
  "IconPicker.remove.button": "Tlačidlo na odstránenie vybranej ikony",
  "IconPicker.emptyState.label": "Nenašla sa žiadna ikona",
  "IconPicker.icon.label": "Vybrať ikonu {icon}",
  ...
  "chat.tooltips.upload-attachments": "Nahrať prílohy",
  "chat.header.default-title": "Nová konverzácia",
  "chat.input.defaults.title": "Ako vám môžem pomôcť?",
  "chat.input.defaults.generate": "Generovať schemu produktu",
  ...
  "chat.messages.too-many-requests": "Príliš veľa requestov, skúste to prosím neskôr.",
  "chat.messages.license-limit-reached": "Bol dosiahnutý limit licencie, skúste to znova zajtra.",
  "chat.messages.license-limit-exceeded": "Limit AI kreditov bol prekročený.",
  "chat.messages.too-long-error": "Táto konverzácia dosiahla maximálnu dĺžku. Začnite novú konverzáciu",
  ...
  "chat.code-upload.drop-zone-folder": "Presuňte sem priečinok alebo",
  "chat.code-upload.drop-zone-browse": "prehľadávať súbory",
  "chat.attachments.menu.import-code": "Importovať kód",
  "chat.attachments.menu.attach-image": "Priložiť obrázok",
  "chat.attachments.menu.import-figma": "Importovať z Figma",
  "chat.feedback.title": "Poskytnúť spätnú väzbu",
  "chat.feedback.subtitle": "Poskytnite dodatočnú spätnú väzbu k tejto správe. Vyberte všetko, čo platí.",
  "chat.feedback.comment.label": "Ako sa môžeme zlepšiť? (voliteľné)",
  "chat.feedback.placeholder": "Vaša spätná väzba...",
  "chat.feedback.submitted": "Ďakujeme za vašu spätnú väzbu!",
  "chat.feedback.error": "Pri odosielaní vašej spätnej väzby sa vyskytla chyba",
  "chat.feedback.reason.invalid_schema": "Neplatná schéma",
  "chat.feedback.reason.bad_recommendation": "Zlé odporúčanie",
  "chat.feedback.reason.slow": "Pomalé",
  "chat.feedback.reason.instructions_ignored": "Pokyny boli ignorované",
  "chat.feedback.reason.being_lazy": "Lenivé správanie",
  "chat.feedback.reason.other": "Iné",
  "chat.figma-upload.step1-title": "Zadajte Figma URL",
  "chat.figma-upload.step2-title": "Náhľad obrázkov",
  "chat.figma-upload.select-images": "Vyberte frames na import",
  "chat.figma-upload.no-images": "V Figma súbore sa nenašli žiadne frames.",
  "chat.figma-upload.import-button": "Importovať",
  "form.button.finish": "Dokončiť",
  "form.button.back": "Späť"
};
export {
  configurations,
  sk as default,
...
//# sourceMappingURL=sk.json-PQ7ACHOO.js.map
