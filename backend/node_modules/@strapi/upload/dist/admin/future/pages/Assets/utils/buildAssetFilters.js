...
const subtractPreset = (now, preset)=>{
...
const buildDateClause = (filter, now)=>{
    const { field } = filter;
...
const buildAssetFilters = (filters, now)=>{
    const fileClauses = [];
    const folderClauses = [];
...
exports.buildAssetFilters = buildAssetFilters;
exports.parseCalendarDate = parseCalendarDate;
//# sourceMappingURL=buildAssetFilters.js.map
