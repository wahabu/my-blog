...
var index$2 = require('./core-api/service/index.js');
var index$1 = require('./core-api/routes/index.js');
...
function createCoreService(uid, cfg) {
    return ({ strapi: strapi1 })=>{
        const baseService = index$2.createService({
            contentType: strapi1.contentType(uid)
        });
    ...
    return {
        ...
        get routes () {
            if (!routes) {
                ...
                const defaultRoutes = index$1.createRoutes({
                    contentType,
                    strapi
                });
