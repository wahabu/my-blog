...
import { Typography, TextButton, Tooltip, Box, Button, IconButton, Flex } from '@strapi/design-system';
...
import { useIsAssetDetailsOpen } from '../hooks/useIsAssetDetailsOpen.mjs';
...
`;
const BulkActionsBar = ({ assets = [], locations = emptyItemLocations, renderedKeys = [] })=>{
