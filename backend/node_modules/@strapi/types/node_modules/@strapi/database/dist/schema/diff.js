...
var createSchemaDiff = ((db)=>{
   ...
   */ const diffIndexes = (oldIndex, index)=>{
        ...
        if (___default.default.xor(oldIndex.columns, index.columns).length > 0) {
            changes.push('columns');
        }
        if (oldIndex.type && index.type && ___default.default.toLower(oldIndex.type) !== ___default.default.toLower(index.type)) {
            changes.push('type');
        }
        return {
