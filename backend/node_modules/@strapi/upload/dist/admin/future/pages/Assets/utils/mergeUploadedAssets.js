...
const isSortField = (value)=>SORT_FIELDS.includes(value);
 ...
 */ const getAssetComparator = (rule = DEFAULT_RULE)=>{
    ...
    const sortField = isKnownField ? field : 'updatedAt';
 ...
 */ const mergeUploadedAssets = ({ assets, uploaded, sort, hasNextPage })=>{
...
exports.getAssetComparator = getAssetComparator;
exports.mergeUploadedAssets = mergeUploadedAssets;
//# sourceMappingURL=mergeUploadedAssets.js.map
