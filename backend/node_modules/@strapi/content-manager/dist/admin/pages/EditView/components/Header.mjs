...
import { useIsDesktop, useNotification, useForm, useIsMobile, useQueryParams, RESPONSIVE_DEFAULT_SPACING, BackButton, useStrapiApp, DescriptionComponentRenderer, useClipboard, useDebounce } from '@strapi/admin/strapi-admin';
import { Flex, Typography, Box, Menu, SingleSelect, SingleSelectOption, IconButton, Popover, Dialog } from '@strapi/design-system';
import { Pencil, ListPlus, WarningCircle, Trash, Duplicate } from '@strapi/icons';
import { useIntl } from 'react-intl';
import { useNavigate, useMatch, useParams } from 'react-router-dom';
import { RelativeTime } from '../../../components/RelativeTime.mjs';
import { CREATED_BY_ATTRIBUTE_NAME, UPDATED_BY_ATTRIBUTE_NAME, PUBLISHED_BY_ATTRIBUTE_NAME, PUBLISHED_AT_ATTRIBUTE_NAME, UPDATED_AT_ATTRIBUTE_NAME, CREATED_AT_ATTRIBUTE_NAME } from '../../../constants/attributes.mjs';
...
const Header = ({ isCreating, status, title: documentTitle = 'Untitled' })=>{
    ...
    const [{ query: { status: activeTab = 'draft' } }] = useQueryParams();
    ...
    return /*#__PURE__*/ jsxs(Flex, {
        ...
        gap: 2,
        children: [
            !isMobile && /*#__PURE__*/ jsx(BackButton, {
                    ...
                    /*#__PURE__*/ jsxs(Flex, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx(Box, {
                                ...
                                children: /*#__PURE__*/ jsx(HeaderDocumentActions, {
                                    activeTab: activeTab,
                                    isCloning: isCloning
                                })
                            })
...
const HeaderDocumentActions = ({ activeTab, isCloning })=>{
    ...
    return /*#__PURE__*/ jsx(DescriptionComponentRenderer, {
        ...
        children: (actions)=>{
            ...
            return /*#__PURE__*/ jsxs(DocumentActionsMenu, {
                ...
                children: [
                    collectionType !== SINGLE_TYPES && /*#__PURE__*/ jsx(CopyDocumentIdMenuItem, {
