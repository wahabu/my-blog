...
const validateUpdateProjectSettings = validateZodSchema(updateProjectSettings);
const validateUpdateProjectSettingsFiles = validateZodSchema(updateProjectSettingsFiles);
const validateUpdateProjectSettingsImagesDimensions = validateZodSchema(updateProjectSettingsImagesDimensions);

export { validateUpdateProjectSettings, validateUpdateProjectSettingsFiles, validateUpdateProjectSettingsImagesDimensions };
//# sourceMappingURL=project-settings.mjs.map
