import { identity, constant, isString, split, join, trim, first, isNil, isEmpty, cloneDeep, isObject, curry, isArray } from 'lodash/fp';
...
const throwQsArrayLimitPopulateError = (entryCount)=>{
    throw new ValidationError(`Too many populate entries (${entryCount}). The maximum number of populate entries when using array notation is ${DEFAULT_QS_ARRAY_LIMIT}. ` + 'Consider using object notation (populate[field]=true), nested population, or reducing the number of fields.');
};
    ...
    function traverse(currentObj, parentPath) {
        for (const [key, value] of Object.entries(currentObj)){
            ...
            if (value === true) {
                ...
                const nestedPopulate = value.populate;
