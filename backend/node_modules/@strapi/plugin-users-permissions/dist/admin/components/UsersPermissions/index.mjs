...
import { memo, forwardRef, useReducer, useImperativeHandle } from 'react';
...
const UsersPermissions$1 = /*#__PURE__*/ forwardRef(({ permissions, routes }, ref)=>{
...
var UsersPermissions = /*#__PURE__*/ memo(UsersPermissions$1);

export { UsersPermissions as default };
