...
import { useRBAC, useNotification, useAPIErrorHandler, isFetchError, useAuth } from '@strapi/admin/strapi-admin';
import { Menu, IconButton, AccessibleIcon } from '@strapi/design-system';
import { More, Pencil, Cross } from '@strapi/icons';
    ...
    allowedActions.canDeleteAction || allowedActions.canUpdate ? /*#__PURE__*/ jsxs(Menu.Root, {
        children: [
            /*#__PURE__*/ jsx(StyledMoreButton, {
                ...
                endIcon: null,
                tag: IconButton,
                icon: /*#__PURE__*/ jsx(AccessibleIcon, {
                    label: formatMessage({
