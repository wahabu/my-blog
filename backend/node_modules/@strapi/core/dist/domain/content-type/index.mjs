...
const warnDraftAndPublishReservedAttributes = (uid, schema)=>{
    ...
    for (const attributeName of contentTypes.findDraftAndPublishReservedAttributeNames(Object.keys(schema.attributes))){
        strapi.log.warn(contentTypes.getDraftAndPublishReservedAttributeWarning(uid, attributeName));
    }
};
