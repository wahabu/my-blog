...
export declare class SingleTypeService extends CoreService implements Core.CoreAPI.Service.SingleType {
    ...
    find(params?: {}): Promise<import("@strapi/types/dist/modules/documents/index.js").AnyDocument | null>;
    createOrUpdate(params?: {}): Promise<import("@strapi/types/dist/modules/documents/index.js").AnyDocument | null>;
