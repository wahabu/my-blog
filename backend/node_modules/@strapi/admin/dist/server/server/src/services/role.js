 ...
 */ const create = async (attributes)=>{
    ...
    const autoGeneratedCode = `${___default.default.kebabCase(attributes.name)}-${utils.dates.timestampCode()}`;
    const rolesWithCode = {
        ...attributes,
 ...
 */ const update = async (params, attributes)=>{
    const sanitizedAttributes = ___default.default.omit(attributes, [
        'code'
    ]);
 ...
 */ const hasSuperAdminRole = (user)=>{
    const roles = ___default.default.get(user, 'roles', []);
