...
export interface VariableDeclarationBuilder {
    (kind: "var" | "let" | "const" | "using" | "await using", declarations: (K.VariableDeclaratorKind | K.IdentifierKind)[]): namedTypes.VariableDeclaration;
    from(params: {
        comments?: K.CommentKind[] | null;
...
export interface ExportNamedDeclarationBuilder {
    (declaration?: K.DeclarationKind | null, specifiers?: (K.ExportSpecifierKind | K.ExportBatchSpecifierKind | K.ExportNamespaceSpecifierKind | K.ExportDefaultSpecifierKind)[], source?: K.LiteralKind | null): namedTypes.ExportNamedDeclaration;
    from(params: {
        assertions?: K.ImportAttributeKind[];
        comments?: K.CommentKind[] | null;
