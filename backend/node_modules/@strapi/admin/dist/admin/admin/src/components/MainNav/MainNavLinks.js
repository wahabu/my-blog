...
const NavLinkBadgeLock = styledComponents.styled(NavLink.NavLink.Badge)`
  background-color: transparent;
`;
const NavLinkBadgeCounter = styledComponents.styled(NavLink.NavLink.Badge)`
  span {
...
const IconContainer = styledComponents.styled(designSystem.Box)`
  svg {
    display: block;
  }
`;
