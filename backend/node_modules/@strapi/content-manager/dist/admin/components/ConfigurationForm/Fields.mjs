   ...
   */ React.useEffect(()=>{
    ...
    return /*#__PURE__*/ jsx(DndContext, {
         ...
         */ const update = produce(containers, (draft)=>{
                ...
                const canCreateNewRowForItem = activeContainerIndex !== overContainerIndex && GRID_COLUMNS - spaceTaken < draggedItem.size;
           ...
           */ if (isNotEnoughSpace) {
               ...
               */ if (insertIndex > overContainerIndex) {
                        ...
                        const findFreeContainerId = (i)=>containersAsDictionary[`container-${i}`] ? findFreeContainerId(i + 1) : `container-${i}`;
