 ...
 * the form fields.
 */
declare const convertEditLayoutToFieldLayouts: (rows: LayoutData["contentType"]["layouts"]["edit"], attributes: Schema["attributes"] | undefined, metadatas: Metadatas, components?: {
 ...
 */
declare const convertListLayoutToFieldLayouts: (columns: LayoutData["contentType"]["layouts"]["list"], attributes: Schema["attributes"] | undefined, metadatas: ListLayout["metadatas"], components?: {
    configurations: Record<string, ComponentConfiguration>;
    schemas: ComponentsDictionary;
