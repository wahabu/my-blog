...
var formatISO__default = /*#__PURE__*/_interopDefault(formatISO);
var isEqual__default = /*#__PURE__*/_interopDefault(isEqual);

const GenericInput = ({ autoComplete, customInputs, description, disabled, intlLabel, labelAction, error, name, onChange, onDelete, options = [], placeholder, required, step, type, value: defaultValue, isNullable: _isNullable, autoFocus, attribute, attributeName, conditionFields, ...rest })=>{
    ...
    const selectValue = typeof value === 'string' || typeof value === 'number' || value === null ? value : undefined;
    const jsonValue = value !== undefined && (typeof value === 'object' || typeof value === 'boolean' || typeof value === 'number') ? JSON.stringify(value, null, 2) : typeof value === 'string' ? value : undefined;
    /*
                    ...
                    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.DatePicker, {
                        ...
                        onChange: (date)=>{
                            onChange({
                                target: {
                                    name,
                                    value: date ? formatISO__default.default(date, {
                                        representation: 'date'
                                    }) : null,
                                    type
                                }
 ...
 */ const MemoizedGenericInput = /*#__PURE__*/ React__namespace.memo(GenericInput, isEqual__default.default);
