...
import { useTypedSelector } from '../../../store/hooks.mjs';
import { selectCompletedUploads } from '../../../store/uploadProgress.mjs';
 ...
 */ const useInfiniteAssets = ({ folder = null, sort, search, filters, enabled = true } = {})=>{
    ...
    const loadedAssets = useMemo(()=>isChangingList ? [] : flattenPages(accumulated.pages), [
        isChangingList,
        accumulated.pages
    ]);
    ...
    const assets = useMemo(()=>{
        ...
        const bridging = completedUploads.filter(({ asset, completedAt })=>getRelationId(asset.folder) === folder && (listAnsweredAfter === undefined || completedAt > listAnsweredAfter));
