...
function default_1(fork) {
    ...
    def("ExportNamedDeclaration")
        .field("specifiers", [or(def("ExportSpecifier"), def("ExportBatchSpecifier"), // preserved from the flow/esprima defs
        def("ExportNamespaceSpecifier"), def("ExportDefaultSpecifier"))], defaults.emptyArray);
    def("CommentBlock")
        .bases("Comment")
