...
const ActionsContainer = styledComponents.styled(designSystem.Flex)`
  border-top: ${({ theme })=>`1px solid ${theme.colors.neutral150}`};
`;
const ContentContainer = styledComponents.styled(designSystem.Box)`
  p {
 ...
 */ const PopoverArrow = styledComponents.styled(designSystem.Popover.Arrow)`
