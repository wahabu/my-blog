...
var getProjectType = require('./utils/getProjectType.js');
...
const renderAdmin = async (mountNode, { plugins, customisations, features })=>{
    ...
    try {
        const { data: { data: { isEE, isTrial, features, flags, ai, planPriceId } } } = await get('/admin/project-type');
        ...
        window.strapi.projectType = getProjectType.getProjectType({
            isEE,
            planPriceId
        });
        // eslint-disable-next-line
