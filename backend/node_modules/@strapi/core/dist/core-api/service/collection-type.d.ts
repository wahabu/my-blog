...
export declare class CollectionTypeService extends CoreService implements Core.CoreAPI.Service.CollectionType {
    ...
    findOne(documentId: Modules.Documents.ID, params?: {}): import("@strapi/types/dist/modules/documents/result/document-engine.js").FindOne<import("@strapi/types/dist/uid/index.js").ContentType, any>;
    create(params?: {
        data: {};
    }): Promise<Modules.Documents.AnyDocument>;
    update(documentId: Modules.Documents.ID, params?: {
        data: {};
    }): import("@strapi/types/dist/modules/documents/result/document-engine.js").Update<import("@strapi/types/dist/uid/index.js").ContentType, any>;
