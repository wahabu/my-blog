...
/* -------------------------------------------------------------------------------------------------
 * Link
 * -----------------------------------------------------------------------------------------------*/ const MainNavLinkStyles = styledComponents.css`
...
const MainNavLinkWrapper = styledComponents.styled(reactRouterDom.NavLink)`
  ${MainNavLinkStyles}
`;
const MainNavLinkAnchor = styledComponents.styled.a`
  ${MainNavLinkStyles}
`;
const MainNavButtonStyles = styledComponents.css`
  padding-block: 1rem;
  padding-inline: 1rem;
`;
const MainNavButtonWrapper = styledComponents.styled(MainNavLinkWrapper)`
  ${MainNavButtonStyles}
`;
const MainNavButtonAnchor = styledComponents.styled(MainNavLinkAnchor)`
  ${MainNavButtonStyles}
`;
