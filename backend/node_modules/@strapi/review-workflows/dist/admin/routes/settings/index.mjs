...
import { Page, useTracking, useRBAC, Table, ConfirmDialog } from '@strapi/admin/strapi-admin';
import { useLicenseLimits } from '@strapi/admin/strapi-admin/ee';
import { LinkButton, Typography, Flex, IconButton, TFooter, Dialog } from '@strapi/design-system';
