 ...
 */
export declare const componentToSchema: (strapi: Core.Strapi, attribute: Schema.Attribute.Component<UID.Component, boolean>) => z.Schema;
/**
 ...
 */
export declare const mediaToSchema: (strapi: Core.Strapi, attribute: Schema.Attribute.Media<Schema.Attribute.MediaKind | undefined, boolean>) => z.Schema;
/**
 ...
 */
export declare const relationToSchema: (strapi: Core.Strapi, attribute: Schema.Attribute.Relation) => z.Schema;
/**
 ...
 */
export declare const booleanToInputSchema: (attribute: Schema.Attribute.Boolean) => z.ZodNullable<z.ZodEnum<{
    true: "true";
    0: "0";
    t: "t";
    1: "1";
