...
const MemoizedRow = /*#__PURE__*/ React.memo((props)=>{
    ...
    const targetContentType = item.type === 'relation' ? get__default.default(contentTypes, item.target) : null;
    const isPluginContentType = get__default.default(targetContentType, 'plugin');
                                                ...
                                                item.type === 'relation' && /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                                                    children: [
                                                        ...
                                                        targetContentType && /*#__PURE__*/ jsxRuntime.jsx(designSystem.Link, {
                                                            ...
                                                            children: upperFirst__default.default(targetContentType.info.displayName)
                                                        }),
...
const ComponentLink = ({ uid })=>{
    ...
    const type = get__default.default(components, uid);
    return /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [
            " (",
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Link, {
                ...
                children: upperFirst__default.default(type.info.displayName)
            }),
            ")"
        ]
    });
