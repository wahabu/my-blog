...
var ExportCard = require('./components/ExportCard.js');
var Modal = require('./components/Modal.js');
var useAuditLogsData = require('./hooks/useAuditLogsData.js');
var useExportAuditLogs = require('./hooks/useExportAuditLogs.js');
...
const ListPage = ()=>{
    ...
    const { allowedActions: { canRead: canReadAuditLogs, canExport: canExportAuditLogs }, isLoading: isLoadingRBAC } = useRBAC.useRBAC(React__namespace.useMemo(()=>[
            ...readPermissions ?? [],
            ...exportPermissions ?? []
        ], [
        readPermissions,
    ...
    const openLog = (id)=>setQuery(useQueryParams.withEncodedUserParams(query, {
            id
        }), 'push', true);
    const closeLog = ()=>setQuery(useQueryParams.withEncodedUserParams(query, {
            id: undefined
        }), 'push', true);
    const { exportAuditLogs, downloadExport, dismissExport, isExporting, progress, exportResult } = useExportAuditLogs.useExportAuditLogs();
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(PageHelpers.Page.Main, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx(Layout.Layouts.Header, {
                ...
                primaryAction: canExportAuditLogs && /*#__PURE__*/ jsxRuntime.jsx(designSystem.Button, {
            ...
            query?.id && /*#__PURE__*/ jsxRuntime.jsx(Modal.Modal, {
                handleClose: closeLog,
                logId: query.id.toString()
            }),
            /*#__PURE__*/ jsxRuntime.jsx(ExportCard.ExportCard, {
                progress: progress,
