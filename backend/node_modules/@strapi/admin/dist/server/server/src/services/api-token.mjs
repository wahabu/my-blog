...
import { pick, uniq, differenceWith, prop, omit, map, difference, isEqual, isArray, isEmpty, isNumber, isNil } from 'lodash/fp';
 ...
 */ const update = async (id, attributes)=>{
    ...
    const baseData = pick(UPDATABLE_FIELDS, attributes);
